...
class LeninAnalyzer:
    ...
    def _create_optimized_prompt(self, context: str, news_title: str, news_content: str) -> str:
        ...
        return (
            ...
            "3. Анализ должен быть кратким (2-3 предложения), конкретным и без общих фраз\n"
            "4. Избегай шаблонных вступлений\n"
            "5. Сфокусируйся на классовой природе события, экономических противоречиях и империалистической практике\n"
            "6. Будь аутентичным - используй характерные для Ленина термины и стиль\n"
            "7. Завершай предложения полностью, без обрывов\n"
            "8. Следи за грамотностью\n\n"
            "Формат ответа:\n"
