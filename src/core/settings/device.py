...
def is_llama_server_active(
    ...
    # Function-local import keeps device.py free of module-level llm coupling.
    from src.core.llm.health import is_llama_server_active as _active

    return _active(server_url=server_url, timeout_sec=timeout_sec)
