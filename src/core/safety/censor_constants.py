...
_SPORT_TOKEN_RE = re.compile(
    r"\b(спорт|футбол|хоккей|хоккеист|теннис|волейбол|баскетбол|матч|турнир|чемпионат|"
    r"атлет|спортсмен|тренер|федерац|лига|кубок|олимп|паралимп|гто|ufc|юфс|"
    r"синхронист)\w*\b",
    re.IGNORECASE,
)
