...
def main() -> int:
    ...
    parser.add_argument("--qa-json", default=".cursor/artifacts/cleaning/cleaning_qa.json")
    parser.add_argument("--summary-md", default=".cursor/artifacts/cleaning/cleaning_summary.md")
    ...
    for row in rows:
        ...
        written += 1
        reductions.append(max(0.0, 1 - (len(cleaned_text) / max(1, len(original_text)))))
    ...
    payload = {
        ...
        "mean_size_reduction_pct": (sum(reductions) / len(reductions) * 100) if reductions else 0.0,
