...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run retrieval migration rollback drill."
    )
    parser.add_argument("--config", default="config/retrieval_pipeline.yaml")
    parser.add_argument(
        "--out-json", default=".cursor/artifacts/retrieval/rollback_drill.json"
    )
    parser.add_argument(
        "--out-md", default=".cursor/artifacts/retrieval/rollback_drill.md"
    )
