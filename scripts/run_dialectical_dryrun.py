...
def main() -> int:
        ...
        news_items = [
            {
                ...
                "content": "Санкции, капитал и империализм в международной политике. " * 5,
            }
    ...
    with out_path.open("w", encoding="utf-8") as handle:
        for item in news_items:
            ...
            concepts = [token for token in ("капитал", "империализм", "санкции") if token in content.casefold()]
            ...
            row = {
                ...
                "r1_jaccard": jaccard_overlap(left_text=fake_analysis, right_text=r1_text),
                "r2_jaccard": jaccard_overlap(left_text=fake_analysis, right_text=r2_text),
                "r3_jaccard": jaccard_overlap(left_text=fake_analysis, right_text=r3_text),
            }
