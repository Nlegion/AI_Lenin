...
def main() -> int:
    ...
    parser.add_argument("--input-jsonl", default="data/external_datasets/external_unified.jsonl")
    parser.add_argument("--output-jsonl", default=".cursor/artifacts/quality/censorship_control_set_latest.jsonl")
    ...
    with out.open("w", encoding="utf-8") as handle:
        for idx, row in enumerate(sampled, start=1):
            handle.write(json.dumps(_to_control_row(row, idx), ensure_ascii=False) + "\n")
