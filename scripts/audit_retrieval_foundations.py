...
def main() -> int:
    ...
    parser.add_argument("--ontology-tags", default=".cursor/artifacts/ontology/ontology_tags.tsv")
    parser.add_argument("--chunks", default=".cursor/artifacts/chunks/chunk_dataset_v2.tsv")
    parser.add_argument("--out-json", default=".cursor/artifacts/evaluation/retrieval_foundations_audit.json")
    parser.add_argument("--out-md", default=".cursor/artifacts/evaluation/retrieval_foundations_audit.md")
