...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build reproducibility manifest for subplan inputs/outputs.")
    parser.add_argument("--subplan", required=True, help="Subplan identifier, for example 'A'.")
    parser.add_argument("--path", action="append", default=[], help="File or directory to hash (repeatable).")
    parser.add_argument(
        "--out",
        required=True,
