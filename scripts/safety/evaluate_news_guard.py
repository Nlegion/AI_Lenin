...
def main() -> int:
    ...
    parser.add_argument(
        "--out-json", default=".cursor/artifacts/safety/news_guard_eval.json"
    )
    parser.add_argument(
        "--out-md", default=".cursor/artifacts/safety/news_guard_eval_summary.md"
    )
    ...
    print(
        f"Provocative blocked/quarantined: {blocked_provocative}/{len(provocative_cases)}"
    )
