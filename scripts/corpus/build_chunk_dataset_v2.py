...
from src.core.preprocessing.chunking_quality import (  # noqa: E402
    bad_boundary_ratio,
...
def main() -> int:
    ...
    parser.add_argument(
        "--chunks-output", default=".cursor/artifacts/chunks/chunk_dataset_v2.tsv"
    )
    parser.add_argument(
        "--summary-output", default=".cursor/artifacts/chunks/chunking_summary.md"
    )
    parser.add_argument(
        "--qa-output", default=".cursor/artifacts/chunks/chunking_qa.json"
    )
