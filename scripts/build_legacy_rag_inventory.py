...
def main() -> int:
    ...
    parser.add_argument("--out-md", default=".cursor/artifacts/legacy/legacy_rag_inventory.md")
    parser.add_argument("--out-json", default=".cursor/artifacts/legacy/legacy_rag_inventory.json")
