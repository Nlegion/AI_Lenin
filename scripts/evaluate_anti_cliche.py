...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluate anti-cliché gate on gold cases.")
    parser.add_argument("--cases", default="data/eval/anti_cliche_cases.jsonl")
    parser.add_argument("--out-json", default=".cursor/artifacts/evaluation/anti_cliche_eval.json")
    parser.add_argument("--out-md", default=".cursor/artifacts/evaluation/anti_cliche_eval.md")
    ...
    print(f"precision={precision:.3f} recall={recall:.3f} warn_rate={payload['warn_rate']:.3f}")
    return 0
