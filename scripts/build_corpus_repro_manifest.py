...
def _source_from_cleaned_path(cleaned_root: Path, source_root: Path, cleaned_file: Path) -> Path:
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build corpus reproducibility manifest.")
    parser.add_argument("--source-root", default="data/books/intellectual")
    parser.add_argument("--cleaned-root", default="data/books/ultimate_cleaned_ontology")
    parser.add_argument("--manifest-version", default="1.0.0")
    parser.add_argument("--out-tsv", default=".cursor/artifacts/cleaning/corpus_repro_manifest_v1.tsv")
    parser.add_argument("--out-md", default=".cursor/artifacts/cleaning/corpus_repro_manifest_v1.md")
